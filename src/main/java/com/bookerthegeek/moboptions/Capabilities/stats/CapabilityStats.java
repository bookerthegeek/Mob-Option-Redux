...
public final class CapabilityStats {
	...
	public static void register() {
		CapabilityManager.INSTANCE.register(IHealth.class, new Capability.IStorage<IHealth>() {
			@Override
			public NBTBase writeNBT(final Capability<IHealth> capability, final IHealth instance,
					final EnumFacing side) {
				return new NBTTagFloat(instance.getBonusMaxHealth());
			}

			@Override
			public void readNBT(final Capability<IHealth> capability, final IHealth instance, final EnumFacing side,
					final NBTBase nbt) {
		...
		CapabilityManager.INSTANCE.register(IAttack.class, new Capability.IStorage<IAttack>() {
			@Override
			public NBTBase writeNBT(final Capability<IAttack> capability, final IAttack instance,
					final EnumFacing side) {
				return new NBTTagFloat(instance.getBonusMaxAttack());
			}

			@Override
			public void readNBT(final Capability<IAttack> capability, final IAttack instance, final EnumFacing side,
					final NBTBase nbt) {
		...
		CapabilityManager.INSTANCE.register(IFollow.class, new Capability.IStorage<IFollow>() {
			@Override
			public NBTBase writeNBT(final Capability<IFollow> capability, final IFollow instance,
					final EnumFacing side) {
				return new NBTTagFloat(instance.getBonusFollowRange());
			}

			@Override
			public void readNBT(final Capability<IFollow> capability, final IFollow instance, final EnumFacing side,
					final NBTBase nbt) {
	...
	public static ICapabilityProvider createProvider(final IFollow follow) {
		return new CapabilityProvider<>(FOLLOW_RANGE_CAPABILITY, DEFAULT_FACING, follow);
	}
